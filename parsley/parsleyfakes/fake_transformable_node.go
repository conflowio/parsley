...
func (fake *FakeTransformableNode) Value(userCtx interface{}) (interface{}, parsley.Error) {
...
func (fake *FakeTransformableNode) Transform(userCtx interface{}) (parsley.Node, parsley.Error) {
